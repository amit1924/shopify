...
const DashboardAdmin = () => {
  ...
  // Fetch products with useCallback to memoize the function
            ...
            <form onSubmit={handleEdit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-blue-500 rounded-lg cursor-pointer bg-gray-700 hover:bg-gray-600 transition-colors">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      {selectedFilePreview || editProduct.images[0] ? (
                        <div className="relative w-full h-full">
                          <img
                            src={selectedFilePreview || editProduct.images[0]}
                            alt="Preview"
                            className="w-full h-24 object-contain"
                          />
                          <p className="mt-2 text-sm text-center text-blue-400">
                            {selectedFile ? selectedFile.name : "Current image"}
                          </p>
                        </div>
                      ) : (
